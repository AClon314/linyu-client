  ...
  useEffect(() => {
    ...
    const setup = async () => {
      try {
        ...
        // 监听隐藏或显示 home 窗口
        const unHideOrShowHome = await listen(
          "hideOrShowHome",
          async function (e) {
    ...
    <div>
      <CustomModal isOpen={isUpdaterOpen}>
        <div className="updater">
          ...
          <div style={{ fontWeight: 600 }}>版本更新</div>
          ...
          {!updating && (
            <div className="updater-operate">
              ...
              <CustomButton width={80} onClick={onUpdater}>
                立即更新
              </CustomButton>
            </div>
          )}
      ...
      <RightClickContent position={userInfoPosition} visible={userInfoVisible}>
        <div className="user-info">
          ...
          >
            <img
              className="user-info-portrait"
              alt=""
              src={userInfo.portrait}
              onClick={() => {
                CreateImageViewer(
                  getFileNameAndType(userInfo.portrait).fileName,
                  userInfo.portrait
                );
              }}
            />
      ...
      <CustomBox className="home">
        ...
        <CustomDragDiv className="home-nav">
            ...
            <CustomModal isOpen={isOpenEditInfo}>
              <div className="edit-info">
                <div className="edit-info-top">
                  <div style={{ fontSize: 12 }}>编辑信息</div>
                      ...
                      <div {...getRootProps()}>
                        ...
                        <div className="portrait-info">
                          ...
                          <div className="portrait-info-cover">
                            <i
                              className={`iconfont icon-xiangji`}
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <div style={{ marginBottom: 20 }}>
                      <CustomInput
                        ...
                        onChange={(v) =>
                          setUserInfo({ ...userInfo, signature: v })
                        }
                      />
                    </div>
                    <div style={{ marginBottom: 20 }}>
                      <CustomInput
                        ...
                        type="date"
                        onChange={(v) =>
                          setUserInfo({ ...userInfo, birthday: v })
                        }
                      />
                    </div>
                  </div>
                ...
                >
                  <CustomButton width={55} onClick={onEditInfo}>
                    保存
                  </CustomButton>
                  <CustomButton
                    width={55}
          ...
          <div className="home-nav-my" onClick={onGetUserInfo}>
            <img
              ...
              return (
                <div
                  ...
                  className={`home-nav-option ${
                    option.key === selectedOptionIndex ? "selected" : ""
                  }`}
                  onClick={() => {
                ...
                >
                  ...
                  <img
                    ...
                    src={`/icon/${
                      option.icon +
                      (option.key === selectedOptionIndex ? "" : "-empty")
                    }.png`}
